...
extension RegistrationNewVC {
    ...
    func doAuthRegistration(_ subjectToken: String, loginType: LoginType) {
        ...
        var tokenURL = WebserviceManager.shared.AUTH_BASE_URL;
        if loginType == .Email {
            self.showLoader(button: self.continueButton)
        }
        else if loginType == .Apple {
            self.showLoader(button: self.appleButton)
            tokenURL = tokenURL + "pyauth/apple/login";
        }
...
//        print("subjectToken \(subjectToken)")
//        print("AUTH_TOKEN_URL \(WebserviceManager.shared.AUTH_TOKEN_URL)")
...
//        
//        print("APP_CLIENT_ID \(WebserviceManager.shared.APP_CLIENT_ID)")
//        print("APP_CLIENT_SECRET \(WebserviceManager.shared.APP_CLIENT_SECRET)")
//        
//        var parameters = [String : String]()
//      
//        var grantType = ""
