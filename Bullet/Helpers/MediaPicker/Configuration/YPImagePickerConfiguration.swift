...
public struct YPImagePickerConfiguration {
    ...
    public var libraryPhotoOnly = YPConfigLibrary()
    public var libraryVideoOnly = YPConfigLibrary()
...
public struct YPConfigLibrary {
    ...
    public var spacingBetweenItems: CGFloat = 3.0
