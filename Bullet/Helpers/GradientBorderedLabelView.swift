...
//  Bullet
//
//  Created by Faris Muhammed on 15/02/22.
...
public class GradientBorderedLabelView: UIView {
    ...
    @IBInspectable public var firstColor: UIColor = UIColor(displayP3Red: 37/255.0, green: 214/255.0, blue: 162/255.0, alpha: 1) {
        didSet {
    ...
    @IBInspectable public var secondColor: UIColor = UIColor(displayP3Red: 37/255.0, green: 166/255.0, blue: 214/255.0, alpha: 1) {
        didSet {
    ...
    private var startColor: UIColor? = UIColor(displayP3Red: 37/255.0, green: 214/255.0, blue: 162/255.0, alpha: 1)
    private var endColor: UIColor? = UIColor(displayP3Red: 37/255.0, green: 166/255.0, blue: 214/255.0, alpha: 1)
