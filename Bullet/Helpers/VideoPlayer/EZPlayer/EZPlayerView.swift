...
//        thumbnailImageView?.autoresizingMask = [.flexibleLeftMargin,.flexibleTopMargin,.flexibleRightMargin,.flexibleBottomMargin]
//        self.addSubview(thumbnailImageView!)
        
//        let button = UIButton()
//        button.frame = CGRect(x: (self.controlView?.frame.size.width ?? 200) - 100, y: (self.controlView?.frame.size.height ?? 200) - 100, width: 50, height: 50)
//        if SharedManager.shared.isAudioEnable == false {
//            player?.systemVolume = 0
//            button.setImage(UIImage(named: "volumeOffHomeVC"), for: .normal)
//        } else {
//            player?.systemVolume = 1
//            button.setImage(UIImage(named: "volumeOnHomeVC"), for: .normal)
//        }
//        button.addTarget(self, action: #selector(setVolume(btnVolume:)), for: .touchUpInside)
...
//    @objc func setVolume(btnVolume: UIButton) {
//
//        if SharedManager.shared.isAudioEnable {
//
//            SharedManager.shared.isAudioEnable = false
//
//            SharedManager.shared.lastAudioValue = player?.systemVolume
//            player?.systemVolume = 0
...
//            if SharedManager.shared.lastAudioValue != nil {
//
//            } else {
//                player?.systemVolume = 1
//            }
