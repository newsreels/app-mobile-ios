...
@objc open class RPicker: NSObject {
    ...
    @objc class func selectDate(title: String? = nil,
                          ...
                          doneText: String = NSLocalizedString("Done", comment: ""),
...
class RPickerController: UIViewController {
    ...
    var doneText: String = NSLocalizedString("Done", comment: "")
    ...
    private let buttonColor = UIColor(displayP3Red: 72/255, green: 152/255, blue: 240/255, alpha: 1)
    private let lineColor = UIColor(displayP3Red: 240/255, green: 240/255, blue: 240/255, alpha: 1)
    ...
    private func setUpThemeMode(isDark: Bool) {
        ...
        let isDarkTheme = selectedThemeType ? isDark : (MyThemes.current == .dark ? true : false)
    ...
    private lazy var doneButton: UIButton = {
        ...
        button.titleLabel?.font = UIFont(name: Constant.FONT_Mulli_BOLD, size: 16)
...
extension RPickerController: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        if (pickerLabel == nil) {
            pickerLabel = UILabel()
            pickerLabel?.font = UIFont(name: Constant.FONT_Mulli_Semibold, size: 16)
