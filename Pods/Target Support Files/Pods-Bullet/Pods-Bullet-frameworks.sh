...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GSPlayer/GSPlayer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LoadingShimmer/LoadingShimmer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MediaWatermark/MediaWatermark.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Mute/Mute.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NVActivityIndicatorView/NVActivityIndicatorView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NicoProgress/NicoProgress.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Skeleton/Skeleton.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SteviaLayout/Stevia.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftAutoLayout/SwiftAutoLayout.framework"
