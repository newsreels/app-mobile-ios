...
public class VideoCropView: UIView {
    ...
    public let videoScrollView = VideoScrollView()
    ...
    private func setupSubviews() {
        ...
        setAspectRatio(aspectRatio, margin: 0, animated: false)
    }
    ...
    public func setAspectRatio(_ aspectRatio: CGSize, margin: CGFloat, animated: Bool) {
    ...
    public func hideCropMask(hide: Bool) {
        if hide {
    ...
    public func hideCropBoxBackground() {
        
        cropMaskView.cropBoxView.backgroundColor = .black
        cropMaskView.frameLayer.strokeColor = UIColor.black.cgColor
    }
